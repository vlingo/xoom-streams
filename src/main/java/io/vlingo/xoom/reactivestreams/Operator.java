...
import io.vlingo.xoom.reactivestreams.operator.Filter;
import io.vlingo.xoom.reactivestreams.operator.FlatMapper;
import io.vlingo.xoom.reactivestreams.operator.Mapper;
...
public interface Operator<T,R> {
   ...
   * @param mapper the {@code Function<T,Source<R>>} that maps from values of T to values of R
